    ...
    <div class="container">
        <div class="reviews__inner">
            <div class="reviews__left">
                ...
                <div class="reviews__slides"><span>01</span>/12</div>
            </div>
            <div class="reviews__content">
                <div class="reviews__slider">
                    <div class="swiper-wrapper">
<?php
$REVIEWS_I18N = json_decode(file_get_contents(__DIR__ . '/../data/strings.json'), true);
$reviewIndex = 0;
...
?>
                        <div class="reviews__slide swiper-slide">
                            <div class="reviews__slide-video">
                                <img class="reviews__slide-image" src="<?= htmlspecialchars($reviewItem['poster']) ?>" alt="<?= htmlspecialchars($reviewItem['alt'] ?? 'Відгук про Hydrophob') ?>" loading="lazy" decoding="async">
