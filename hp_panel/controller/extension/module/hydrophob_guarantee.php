...
class ControllerExtensionModuleHydrophobGuarantee extends Controller {
	...
	protected function validate() {
		...
		if (isset($this->request->post['module_hydrophob_guarantee_title']) && is_array($this->request->post['module_hydrophob_guarantee_title']) && trim(strip_tags((string)($this->request->post['module_hydrophob_guarantee_title'][2] ?? ''))) === '') {
