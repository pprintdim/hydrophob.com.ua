<?php
/**
 * Адмін-заглушка для content_top модуля "hydrophob_hero" (hydrophob.net.ua).
...
class ControllerExtensionModuleHydrophobHero extends Controller {
	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			$this->model_setting_setting->editSetting('module_hydrophob_hero', $this->request->post);
		...
		if (isset($this->request->post['module_hydrophob_hero_status'])) {
			$data['module_hydrophob_hero_status'] = $this->request->post['module_hydrophob_hero_status'];
		} else {
			$data['module_hydrophob_hero_status'] = $this->config->get('module_hydrophob_hero_status');
		}
