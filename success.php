...
<head>
    ...
    <link rel="stylesheet" href="catalog/view/theme/default/stylesheet/hydrophob.css">
    <style>
        .successPage{
            min-height: 100vh;
            display: flex;
...
<body class="body">
    <main class="successPage">
        <a class="successPage__logo" href="index.php"><img src="image/hydrophob/logo.svg" alt="Hydrophob"></a>
